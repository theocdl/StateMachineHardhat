...
class ForkStateManager {
    ...
    async getContractStorage(address, key) {
        ...
        const cleared = (_a = account === null || account === void 0 ? void 0 : account.get("storageCleared")) !== null && _a !== void 0 ? _a : false;
    ...
    async putContractStorage(address, key, value) {
        ...
        if (unpaddedValue.length === 0) {
            ...
            newStorage = currentStorage.delete(ethereumjs_util_1.bufferToHex(key));
        }
        else {
            newStorage = currentStorage.set(ethereumjs_util_1.bufferToHex(key), ethereumjs_util_1.bufferToHex(unpaddedValue));
        }
